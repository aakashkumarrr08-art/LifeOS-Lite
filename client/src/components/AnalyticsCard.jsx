    ...
    <article className="relative overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 p-6 text-white shadow-soft">
      ...
      <div className="relative flex h-full flex-col justify-between gap-6 sm:flex-row sm:items-center">
        <div>
          ...
          <h3 className="mt-3 text-3xl font-semibold tracking-tight">Your academic momentum</h3>
          <p className="mt-3 max-w-md text-sm leading-6 text-slate-300">{description}</p>
          <span className={`mt-5 inline-flex rounded-full border px-3 py-1 text-sm font-semibold ${style.badge}`}>
            {summary}
          </span>
        </div>

        <div className={`flex h-32 w-32 shrink-0 items-center justify-center rounded-full bg-gradient-to-br ${style.ring} p-1 shadow-lg`}>
